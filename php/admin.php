...
<?php else: ?>
    ...
    <div class="box">
        ...
        <script>
        const listInput = document.querySelector('input[name="ls"]');

        document.addEventListener('keydown', e => {
            const lsInput = listInput;

            // BACKSPACE → visszalépés, ha nem inputban vagyunk
            if(e.key === "Backspace" && document.activeElement !== lsInput){
                e.preventDefault();
                history.back();
                return;
            }
            ...
            if(e.key === "Escape" && document.activeElement !== lsInput){
                e.preventDefault();
